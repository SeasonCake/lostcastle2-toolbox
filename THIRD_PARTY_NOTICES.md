...
- The local v1.6.2 bundle contains 53 maintainer-selected community MOD entries through 2026-08-30. It adds Max Players 1.3.0 by 梦羽 as the exact 15,872-byte `LostCastle2MaxPlayers16.dll`; the source package's BepInEx runtime, cache, generated config, and duplicate support files are not redistributed as part of this MOD.
...
- Bundled identity: `6.0.0-be.785+6abdba47eeebe08552282e7a58ef0f4a9ab60b62`. Published v1.6.1 pairs it with LC2 Combat Bridge 0.4.8; the local v1.6.2 candidate pairs the same runtime with Bridge 0.4.12.
