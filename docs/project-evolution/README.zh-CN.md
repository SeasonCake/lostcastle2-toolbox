...
本目录把失落城堡2工具箱从早期宏与单人统计，到多人实时数据、自动运行环境、社区 MOD 管理、v1.7.1 分享版、v1.7.2 维护候选、v1.7.4 发布与 v1.7.6 本地发布候选的工程记录串成一条可复用证据链。
...
5. [v1.7.4 发布说明](../LC2_1.7.4_RELEASE_NOTES_2026-09-04.zh-CN.md)：查看当前稳定版的 DPS、结算、MOD、公开包验证与已知边界。
6. [v1.7.6 发布说明](../LC2_1.7.6_RELEASE_NOTES_2026-09-04.zh-CN.md)：查看界面、按键、宏、MOD 迁移、强退隔离和本地发布候选验证。
...
- [v1.7.4 发布说明](../LC2_1.7.4_RELEASE_NOTES_2026-09-04.zh-CN.md)
- [v1.7.6 发布说明](../LC2_1.7.6_RELEASE_NOTES_2026-09-04.zh-CN.md)
- [v1.7.4 结算、承伤与发布准备回执](../../artifacts/package-verification/2026-09-03-toolbox-1.7.4-settlement-taken-release-prep/README.zh-CN.md)
- [v1.7.2 DPS 维护记录](../LC2_1.7.2_DPS_MAINTENANCE_2026-09-03.zh-CN.md)
