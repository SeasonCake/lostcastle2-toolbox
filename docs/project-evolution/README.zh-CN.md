...
本目录把失落城堡2工具箱从早期宏与单人统计，到多人实时数据、自动运行环境、社区 MOD 管理、v1.7.1 分享版、v1.7.2 维护候选、v1.7.4 与 v1.7.6 发布的工程记录串成一条可复用证据链。
...
5. [v1.7.4 发布说明](../LC2_1.7.4_RELEASE_NOTES_2026-09-04.zh-CN.md)：查看上一正式版的 DPS、结算、MOD 与公开包验证。
6. [v1.7.6 发布说明](../LC2_1.7.6_RELEASE_NOTES_2026-09-04.zh-CN.md)：查看当前稳定版的界面、按键、宏、MOD 迁移、强退隔离和发布验证。
