...
本目录把失落城堡2工具箱从早期宏与单人统计，到多人实时数据、自动运行环境、社区 MOD 管理和 v1.7 正式候选的工程记录串成一条可复用证据链。
...
5. [v1.7 发布说明](../LC2_1.7_RELEASE_NOTES_DRAFT_2026-09-02.zh-CN.md)：查看当前正式候选面向用户的变化与边界。
