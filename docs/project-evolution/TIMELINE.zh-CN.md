...
## 2026-09-04：v1.7.5 诊断与 v1.7.6 正式发布
...
- 最终群包与 public-core 均通过完整测试、包自检、隐私边界、逐文件 ZIP 对照和 Windows/Tk receipt。群包已由维护者确认分发；GitHub `main`、`v1.7.6`、Latest Release 与公开下载回读完成，发布提交为 `f369490cc9…982dd5`，公开资产为 58,229,771 B / `1CAD53F9…B80A9`。
