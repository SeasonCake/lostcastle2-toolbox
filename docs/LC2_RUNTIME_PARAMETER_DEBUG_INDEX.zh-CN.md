...
| 当前项目源码 | Bridge `0.4.3`；保留 14 个 Hook；0.4.2 法力小数与闪避回蓝已实测，0.4.3 增加 `loss` 合同并把承伤/HP/MP 资源限定为本地玩家，真实锁血切换待测 |
| 当前游戏目录 | Bridge `0.4.3`，SHA-256 `2837F6C485F691BB743CEAF3EB5EBE2BB5FA1D66A19E1FB2D4B87F029CF562A3`；0.4.2 exact rollback 已保留。显示模式保持“窗口化全屏”（两份 `GameSettings.mFullScreenMode=2`） |
| 桌面端 | `1.5.12-锁血兼容测试版` 已打包并复制到桌面；EXE SHA-256 `4E48267FFDBB5868FFC0890FBC67E7B74CB2B2353EC38A5EB8404FABEB8DAD31`；冻结 EXE 的 100%/200% 战斗页与 200% 四人 HUD 均 `VERIFIED` |
