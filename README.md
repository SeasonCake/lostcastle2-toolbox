...
Current stable release: [v1.7.4](https://github.com/SeasonCake/lostcastle2-toolbox/releases/tag/v1.7.4). See the [v1.7.4 release notes](docs/LC2_1.7.4_RELEASE_NOTES_2026-09-04.zh-CN.md) for the exact changes, verification, and known limits.
