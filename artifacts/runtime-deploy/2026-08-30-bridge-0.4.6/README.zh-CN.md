...
- 测试盒子：`<desktop>/失落城堡2工具箱 1.6.0-Bridge0.4.6测试版`；由正式目录复制，仅 `_internal/assets/lc2_runtime_manifest.json` 与 `_internal/third_party/lc2_runtime/LC2CombatBridge.dll` 两处不同，EXE `--self-test` 退出码 0。正式盒子目录未修改。
