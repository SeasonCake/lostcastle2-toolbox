...
| 综合主窗口与外部战斗 HUD | 已接入演示/回放数据；实时桥接待实现 |
...
临时 BepInEx 探针的说明见 [`game_plugins/LC2DamageProbe/README.zh-CN.md`](game_plugins/LC2DamageProbe/README.zh-CN.md)。它只用于研究，不是最终 HUD 桥。
...
本项目源码使用 [MIT License](LICENSE)。游戏代码、美术资源、名称和商标不在本许可范围内。
